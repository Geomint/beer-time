...
@app.route('/')
def index():
    return render_template("index.html", body_id="our-favourites", page_title="Home")


@app.route('/whats-hot')
def hot():
    return render_template("whats-hot.html", body_id="our-favourites", page_title="What's Hot")
...
@app.route('/sign-in')
def signIn():
    return render_template("sign-in.html", body_id="our-favourites", page_title="Sign In")


@app.route('/contact')
def contact():
    return render_template("contact-us.html", body_id="our-favourites", page_title="Contact Us")
